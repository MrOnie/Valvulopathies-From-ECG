...
function [assigned_states,t1,norm_sig] = runSpringerSegmentationAlgorithm(audio_data, Fs, B_matrix, pi_vector, total_observation_distribution, figures)
...
norm_sig = normalise_signal(audio_data);
